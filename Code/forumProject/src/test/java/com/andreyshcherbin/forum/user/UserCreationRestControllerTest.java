...
import com.andreyshcherbin.forum.user.Gender;
import com.andreyshcherbin.forum.user.Role;
import com.andreyshcherbin.forum.user.User;
import com.andreyshcherbin.forum.user.UserCreationForm;
import com.andreyshcherbin.forum.user.UserService;
...
public class UserCreationRestControllerTest extends IntegrationTestCase {
    ...
    private UserCreationForm makeUserCreationForm(int id) {
        ...
        userCreationForm.setGender("male");
